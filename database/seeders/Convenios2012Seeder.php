...
class Convenios2012Seeder extends Seeder
{
    public function run()
    {
        ...
        $datos = [
            ['008-2012', 'INTERBANK', 'Empresa Internacional', 'CONTRATO DE LÍNEA DE CRÉDITO POR CONVENIO', null, null, 'Internacional'],
            ['019-2012', 'INSTITUTO NACIONAL DE SALUD', 'Salud', 'CONVENIO MARCO DE COOPERACIÒN ENTRE EL INSTITUTO NACIONAL DE SALUD Y LA UNIVERSIDAD NACIONAL DEL CENTRO DEL PERÚ', '2012-06-01', null, 'Internacional'],
        ];
