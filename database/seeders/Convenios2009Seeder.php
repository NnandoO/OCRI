...
class Convenios2009Seeder extends Seeder
{
    public function run()
    {
        ...
        $datos = [
            ['013-2009', 'FUDEC', 'Otros', 'CONVENIO MARCO DE COOPERACIÓN ENTRE LA UNCP Y LA FUNDACIÓN PARA EL DESARROLLO DEL CENTRO DEL PERÚ', '2009-02-11', null, 'Internacional'],
        ];
