...
class Convenios2010Seeder extends Seeder
{
    public function run()
    {
        ...
        $datos = [
            ['003-2010', 'FUDEC', 'Otros', 'CONVENIO MARCO DE COOPERACION ENTRE LA UNIVERSIDAD NACIONAL DEL CENTRO DEL PERÚ Y LA FUNDACION PARA EL DESARROLLO DEL CENTRO DEL PERU', '2010-01-12', null, 'Internacional'],
            ['029-2010', 'ELECTROCENTRO S.A.', 'Empresa Internacional', 'CONVENIO DE CESIÓN EN USO Y USUFRUCTO DE UN TERRENO QUE  OTORGA  LA  UNIVERSIDAD NACIONAL DEL CENTRO DEL PERÚ A ELECTROCENTRO S.A. PARA LA CONSTRUCCIÓN  DE LA SUBESTACIÓN  DE TRANSFORMACIÓN  EN SATIPO', '2010-05-05', '2040-05-05', 'Internacional'],
        ];
